...
@WebServlet(name = "MovieFutureController", urlPatterns = "/movieFuture")

public class MovieFutureController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        movies = movieService.getMovieFuture();
        ...
        request.setAttribute("movies_future", moviesOnPage);
        request.setAttribute("totalPages", totalPages);
        request.setAttribute("currentPage", currentPage);
        request.getRequestDispatcher("Pages/movie-show-future.jsp").forward(request, response);
